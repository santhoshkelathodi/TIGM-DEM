...
trajectory_path = '/home/sk47/workspace/trackdata/Dataset/QMUL/original_trajectory'
...
tid, t, label = np.loadtxt('DBSCAN_cluster_result.out', usecols=(0, 5, 6), unpack=True, dtype='int')
