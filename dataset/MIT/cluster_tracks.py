...
default_base = {'quantile': .01, #'quantile': .3, .0549 :smaller value more number of clusters
                'eps': .27,# smaller value more number of clusters Earlier value = 0.83
...
XObs = np.c_[x1, y1, x2, y2] # Not including time dimention for MIT & GCS
#print XObs
