...
trajectory_path = '/home/sk47/workspace/trackdata/Dataset/UCF_Crowd/custTrajectory'
bg_image_path = '../ucf_bg.jpg'
...
tid, t, label = np.loadtxt('TIGM_cluster_result.out', usecols=(0, 5, 6), unpack=True, dtype='int')
