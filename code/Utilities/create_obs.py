...
trajectory_path = './gKLT_GT_50_ALL_REINDEXED'
...
track_obs = np.c_[x1_numpy, y1_numpy, x2_numpy, y2_numpy, t_numpy, tid_numpy]
print track_obs
np.savetxt('track_obs_gKLT.txt', track_obs, fmt="%i", delimiter='\t')
#print label
